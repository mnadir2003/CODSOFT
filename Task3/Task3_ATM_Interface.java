...
public class Task3_ATM_Interface {
    ...
    public Task3_ATM_Interface(BankAccount[] accounts) {
    ...
    public static void main(String[] args) {
        ...
        BankAccount[] accounts = {
                new BankAccount("1234567890", "1234", 1000),
                new BankAccount("2345678910", "9876", 9000),
                new BankAccount("7890123456", "5432", 15000)
        };
        Task3_ATM_Interface atm = new Task3_ATM_Interface(accounts);
